...
<body>
	...
	<c:set var="boardNotice" value="${requestScope.boardNotice}" />
	...
	<header class="header">
		...
		<div class="header-main">
			<h1 class="logo">
				<a href="../mainpage.jsp"> <img src="../img/Giggle3.png"
					alt="로고" width="200px" height="63px" />
				</a>
			</h1>
			<nav class="menu1">
				<ul>
	...
	<main class="main">
		<div class="page-top1">
			...
			<hgroup class="page-top-inner-wrap">
				...
				<!--공지사항-->
				<div class="cs-table01-wrap">
					<form class="noti-search"></form>
								...
								<c:when
									...
									<c:forEach var="board" items="${boardList}">
										<tr>
											...
											<td>
												<p class="view-count">${board.boardreadcount}</p>
											</td>
										</tr>
									</c:forEach>
								</c:when>
