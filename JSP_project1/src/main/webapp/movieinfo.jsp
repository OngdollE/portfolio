					...
					<section class="player-contents">
						<div class="poster-box">
							<div class="picture-area">
								...
								<!--포스터썸네일--> <img src="img/16-b.png" class="poster-thumb">
								</picture>
								<div class="play-area">
									<p class="moviename">
									<h1>영화제목</h1>
        	...
        	<video id="videoPlayer" controls width="1280" height="720">
				...
				<div id="popup" class="popup" style="display: none;">
					<div class="popup-content">
						...
						<div class="sns-box">
							<li><a
								href="https://twitter.com/i/flow/login?redirect_after_login=%2Fintent%2Ftweet%3Ftext%3D%5Bwavve%5D%2520%25EA%25B5%25AD%25EB%25AF%25BC%25EC%2582%25AC%25ED%2598%2595%25ED%2588%25AC%25ED%2591%259C%250a1%2520%25ED%259A%258C%2520%25EA%25B5%25AD%25EB%25AF%25BC%25EC%2582%25AC%25ED%2598%2595%25ED%2588%25AC%25ED%2591%259C%25EB%25A5%25BC%2520%25EC%258B%259C%25EC%259E%2591%25ED%2595%2598%25EA%25B2%25A0%25EC%258A%25B5%25EB%258B%2588%25EB%258B%25A4%250a%26url%3Dhttps%253A%252F%252Fwww.wavve.com%252Fplayer%252Fvod%253Fprogramid%253DS01_P466239300"><div
										class="sns-img">
										<img src="img/twitter_logo.png" alt="twitter">
									</div> <strong>트위터</strong></a></li>
							<li><a
								href="https://accounts.kakao.com/login/?continue=https%3A%2F%2Fcs.kakao.com%2Fhelps%3Fservice%3D52%26category%3D166%26locale%3Dko#login"><div
										class="sns-img">
										<img src="img/kakao_logo.png" alt="kakao">
									</div> <strong>카카오</strong></a></li>
							<li><a
								href="https://access.line.me/oauth2/v2.1/login?returnUri=%2Foauth2%2Fv2.1%2Fauthorize%2Fconsent%3Fresponse_type%3Dcode%26client_id%3D1397264795%26redirect_uri%3Dhttps%253A%252F%252Fcreator.line.me%252Fsignup%252Fline_callback%26state%3Dd8THUP6RdZkaAJOObdxXm2h7SKkM0RzV%26scope%3Dprofile&loginChannelId=1397264795&loginState=7E1AKOokHzMCMbhRhyzZOr#/"><div
										class="sns-img">
						...
						<div class="detail-view-box">
							<div class="thumb-img-box">
								<div class="picture-area-in">
									...
									<!--영화 미니 포스터--> <img src="img/16-p.png" alt=""
										class="thumb-img"> </picture>
								</div>
							</div>
							<div class="detail-info-box">
								<em class="preview-subtitle"> 영화 제목 </em>
								<p class="detail-dsc">"영화 상세정보 줄거리 ~~~~~~</p>
								<table class="detail-info-table">
									...
									<tr>
										<th scope="row">장르</th>
										<td><a href="" class="genre"> #장르1 </a>, <a href=""
											class="genre"> #장르2 </a> <!----></td>
									</tr>
									<tr>
										<th scope="row">출연</th>
										<td><a href="" class="genre"> 배우1 </a>, <a href=""
											class="genre"> 배우2 </a>, <a href="" class="genre"> 배우3 </a>,
											<a href="" class="genre"> 배우4 </a></td>
									</tr>
									<tr>
										<th scope="row">감독</th>
										<td><a href="javascript:void(0)" class="genre"> 감독 </a> <!---->
										</td>
									</tr>
									<tr>
										<th scope="row">등급</th>
										<td><span> <!--등급 아이콘--> <img
												src="img/everyicon.png" width="50" height="50" :alt="전체이용가">
										</span></td>
									</tr>
								</table>
							</div>
						...
						<ul class="swiper-wrapper">
							<li class="swiper-slide"><a
								href="${pageContext.request.contextPath}/BoardList.mo">
									[점검안내] 9월 23일 Giggle 사이트 점검 </a></li>
							<li class="swiper-slide"><a
								href="${pageContext.request.contextPath}/BoardList.mo">
									[점검안내] 9월 21일 게시판 점검 </a></li>
							<li class="swiper-slide"><a
								href="${pageContext.request.contextPath}/BoardList.mo">
	...
	<div class="footer-menu">
		<div class="footer-info">
			<ul>
				...
				<li><a href="#">김호년 &nbsp 이희영 &nbsp 송화준 &nbsp 이현지 &nbsp 이동현
						&nbsp 김현욱</a></li>
