...
<body>
	...
	<main class="main">
		...
		<form action="${pageContext.request.contextPath}/noticeboard.mo" name="noticeForm" method="post">
			<div class="cs-table-a">
				...
				<div class="noti-detail">
					<textarea class="contenttext" name="boardcontent" id="content"
						placeholder="내용을 입력하세요"></textarea>
				</div>
				<div class="input-button">
					<button type="button" class="cancle-btn">
						<span><a href="${pageContext.request.contextPath}/BoardList.mo">취소</a></span>
					</button>
