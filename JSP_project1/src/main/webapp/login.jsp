	...
	<main class="member">
		<div class="login member-layout">
			...
			<div class="join-sns-box">
				...
				<form
					action="${pageContext.request.contextPath}/giggle/LoginAction.mo"
					name="login_form" id="login_form" method="post">
					<fieldset>
						<legend>로그인 양식</legend>
						<ul class="input-wrap01">
							<li><label> <input type="text" name="user_id"
									id="user_id" placeholder="이메일 주소 또는 아이디" title="아이디"
									class="input-style01">
							</label>
								<div id="idAlert"></div></li>
							<li><label> <input type="password" name="user_pw"
									id="user_pw" placeholder="비밀번호" title="비밀번호"
									class="input-style01">
							</label>
								<div id="pwAlert"></div></li>
							<div class="btn-purple btn-purple-dark">
								<a onclick="return submit_check();"
									href="javascript:document.login_form.submit();">로그인</a>
							</div>
					</fieldset>
				</form>
				<ul class="join-find">
			...
			<div class="sns-box">
				<p class="sns-exclamation">
					<span> 로그인을 하시면 Giggle의 수많은 컨텐츠를 감상하실 수 있습니다.</span>
					 <span> 아이디가 없으신가요? 회원가입버튼을 눌러 Giggle에 가입하세요!</span>
				</p>
			</div>
		</div>
	</main>
