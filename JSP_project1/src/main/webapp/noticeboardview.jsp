...
<body>
	<c:set var="NoticeBoardView" value="${requestScope.NoticeBoardView}" />
	<header class="header">
		<div class="menu-top">
          <nav class="menu2">
            <ul>
		...
		<div class="cs-table-a">
			<table class="cs-table">
				...
				<tbody>
					<tr>
						<td>
							<p class="noti-nick">${NoticeBoardView.notice_sect}</p>
						</td>
						<td>
							<p class="noti-title">${NoticeBoardView.boardtitle}</p>
						</td>
						<td>
							<p class="noti-date">${NoticeBoardView.boarddate}</p>
						</td>
					</tr>
				</tbody>
			</table>
			<div class="noti-detail">
				<textarea class="contenttext" name="content" id="content" readonly>${NoticeBoardView.boardcontent }</textarea>
			</div>
			<div class="list-btn">
