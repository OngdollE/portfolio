...
<body>
    ...
    <div class="head-banner">
        <div class="head-logo">
            ...
            <h2 tabindex="0" class="event-top-text">Giggle의 다양한 이벤트를 만나보세요.</h2>
        </div>
    </div>
    <!--메뉴 선택바-->
    ...
    <div class="event-body">
        <div class="event-wrap">
            <div class="event-detail">
                <h3 tabindex="0" class="event-title"><곡성> 론칭 프로모션</h3>
                <p class="event-date">2023-09-11 ~ 2023-9-30</p>
                <a href="eventpage.jsp" class="event-list">
                    <img src="img/menu.png" alt="목록">
                    <span class="list-icon">목록</span>
                </a>
            </div>
            <div class="event-info">
                <div class="event-img">
                    <img src="img/event.png" alt="이벤트 내용">
                </div>
            </div>
        </div>
    </div>
