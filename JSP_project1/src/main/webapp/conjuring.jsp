                  ...
                  <div class="poster-box">
                    <div class="picture-area">
                      <picture>
                          ...
                          <!--포스터썸네일-->
                          <img src="img/1-b.png" class="poster-thumb">
                      </picture>
                  <div class="play-area">
	...
	<div id="videoPopup" class="popup" style="display: none;">
        <div class="popup-video-content">
            <video controls id="videoPlayer" style="width: 100%; height: 100%;">
                <source src="https://rr3---sn-oguelnzs.c.drive.google.com/videoplayback?expire=1695099437&ei=_f8IZaOgG7z5-LYP_r6z6A0&ip=220.117.144.29&cp=QVROV0FfWFRRSFhPOmxoMFF2LXZNWW9MZmxaNDZ2Z1JOMFNVSlllSzdOSExHUW5zODk1TUoyWUQ&id=743153a144cc850d&itag=37&source=webdrive&requiressl=yes&mh=Gc&mm=32&mn=sn-oguelnzs&ms=su&mv=m&mvi=3&pl=18&ttl=transient&susc=dr&driveid=1Y703MSghfglkyjL4tU1pBXSuzNNyMOm5&app=explorer&mime=video/mp4&vprv=1&prv=1&dur=161.192&lmt=1695085011060873&mt=1695088370&subapp=DRIVE_WEB_FILE_VIEWER&txp=0001224&sparams=expire,ei,ip,cp,id,itag,source,requiressl,ttl,susc,driveid,app,mime,vprv,prv,dur,lmt&sig=AOq0QJ8wRgIhAOKXG6n_iTf_WvYRJL9h5obikWQfJn4NVwJbfC9f-p6DAiEA0DtOYsdB6Zgj1JpP1MHTeIAcybTOUUfJrA4QaMuaV28=&lsparams=mh,mm,mn,ms,mv,mvi,pl&lsig=AG3C_xAwQwIfD6ruYv64UqGR5lmPNNIvW3dOE4WGKOVT6apU9dTYsQIgCxnEZoq25RCUhY-LCujNKckaaMrXg27_c0V9p6L0iro=&cpn=KpYsY60B2IruYNOi&c=WEB_EMBEDDED_PLAYER&cver=1.20230910.00.02">
          	</video>
        ...
        <div class="thumb-img-box">
          <div class="picture-area-in">
            <picture><source srcset="" type="image/webp">
              <!--영화 미니 포스터-->
              <img src="img/1-p.png" alt="" class="thumb-img">
            </picture>
          </div>
        </div>
    ...
    <th scope="row">
      등급
        ...
        <td>
          <span>
        <!--등급 아이콘-->
        <img src="img/15.png" width="50" height="50" :alt="15세 이용가">
          </span>
        </td>
      </tr>
      </table>
